...
import com.junkfood.vdownloader.util.FileUtil.getFileSize
...
class VideoListViewModel : ViewModel() {
    ...
    fun updateVideoTitle(videoInfo: DownloadedVideoInfo, newTitle: String) {
        viewModelScope.launch(Dispatchers.IO) {
            DatabaseUtil.updateVideoInfo(videoInfo, newTitle)
        }
    }
