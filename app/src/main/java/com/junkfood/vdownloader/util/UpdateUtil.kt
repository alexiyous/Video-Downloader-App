...
import com.junkfood.vdownloader.util.FileUtil.getFileProvider
import com.junkfood.vdownloader.util.PreferenceUtil.getInt
import com.junkfood.vdownloader.util.PreferenceUtil.updateLong
...
object UpdateUtil {
    ...
    private const val REPO = "VDownloader"
